...
ExplainBack 是一个费曼学习法 AI 陪练 MVP。用户粘贴学习资料后，系统先生成知识地图，再围绕每个知识点完成“解释、追问、分层支持、重新验证”的训练闭环。AI 只依据用户资料判断，不直接替用户完成解释。

当前版本聚焦核心学习流程，暂不包含登录、PDF 上传、向量检索和多用户数据隔离。

## 核心流程

1. 输入学习主题和不少于 100 字的纯文本或 Markdown 资料。
2. AI 从资料中生成 1～10 个知识点。
3. 用户用自己的话解释当前知识点。
